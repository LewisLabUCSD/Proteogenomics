...
#     print ':::::::java -Xmx3500M -cp '+system_folder+'/MSGFPlus.20130403/MSGFPlus.jar edu.ucsd.msjava.msdbsearch.BuildSA -d '+db+'/prep/'+os.path.splitext(db_piece)[0]+'/'+db_piece+' -tda 2'
    ...
    os.system('java -Xmx1000M -cp '+system_folder+'/MSGFPlus.20130403/MSGFPlus.jar edu.ucsd.msjava.msdbsearch.BuildSA -d '+db+'/prep/'+os.path.splitext(db_piece)[0]+'/'+db_piece+' -tda 2')
    return
